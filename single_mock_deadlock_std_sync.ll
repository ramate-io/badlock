; ModuleID = 'single_mock_deadlock_std_sync.a040118f-cgu.0'
source_filename = "single_mock_deadlock_std_sync.a040118f-cgu.0"
...
@vtable.0 = private unnamed_addr constant <{ ptr, [16 x i8], ptr, ptr, ptr }> <{ ptr @"_ZN4core3ptr85drop_in_place$LT$std..rt..lang_start$LT$$LP$$RP$$GT$..$u7b$$u7b$closure$u7d$$u7d$$GT$17h91c4e3eea4b95564E", [16 x i8] c"\08\00\00\00\00\00\00\00\08\00\00\00\00\00\00\00", ptr @"_ZN4core3ops8function6FnOnce40call_once$u7b$$u7b$vtable.shim$u7d$$u7d$17h62f47b32500d06d3E", ptr @"_ZN3std2rt10lang_start28_$u7b$$u7b$closure$u7d$$u7d$17hd22e2ea2d697e22eE", ptr @"_ZN3std2rt10lang_start28_$u7b$$u7b$closure$u7d$$u7d$17hd22e2ea2d697e22eE" }>, align 8
...
define internal void @_ZN3std10sys_common9backtrace28__rust_begin_short_backtrace17h42ffdd5f31c7feecE(ptr %f) unnamed_addr #0 {
start:
; call core::ops::function::FnOnce::call_once
  call void @_ZN4core3ops8function6FnOnce9call_once17h369d1d6d7cc4d91aE(ptr %f)
...
define hidden i64 @_ZN3std2rt10lang_start17hea127707a9dda385E(ptr %main, i64 %argc, ptr %argv, i8 %sigpipe) unnamed_addr #1 {
start:
...
define internal i32 @"_ZN3std2rt10lang_start28_$u7b$$u7b$closure$u7d$$u7d$17hd22e2ea2d697e22eE"(ptr align 8 %_1) unnamed_addr #2 {
start:
  %self = alloca i8, align 1
  %_4 = load ptr, ptr %_1, align 8, !nonnull !4, !noundef !4
; call std::sys_common::backtrace::__rust_begin_short_backtrace
  call void @_ZN3std10sys_common9backtrace28__rust_begin_short_backtrace17h42ffdd5f31c7feecE(ptr %_4)
; call <() as std::process::Termination>::report
  %0 = call i8 @"_ZN54_$LT$$LP$$RP$$u20$as$u20$std..process..Termination$GT$6report17h7bba0d73e21038beE"()
...
; Function Attrs: inlinehint nonlazybind uwtable
define internal void @_ZN3std3sys4unix5locks11futex_mutex5Mutex4lock17h5c2d8edf9743850fE(ptr align 4 %self) unnamed_addr #2 {
start:
  %_15 = alloca i8, align 1
  %_4 = alloca { i32, i32 }, align 4
; call core::sync::atomic::atomic_compare_exchange
  %0 = call { i32, i32 } @_ZN4core4sync6atomic23atomic_compare_exchange17h0c52953451464bb6E(ptr %self, i32 0, i32 1, i8 2, i8 0)
...
; Function Attrs: inlinehint nonlazybind uwtable
define internal void @"_ZN3std4sync5mutex14Mutex$LT$T$GT$3new17h486fe7b43ded0ff3E"(ptr sret(%"std::sync::mutex::Mutex<i32>") %0, i32 %t) unnamed_addr #2 {
start:
...
; Function Attrs: nonlazybind uwtable
define internal void @"_ZN3std4sync5mutex14Mutex$LT$T$GT$4lock17h8dad7da268b6d1f1E"(ptr sret(%"core::result::Result<std::sync::mutex::MutexGuard<'_, i32>, std::sync::poison::PoisonError<std::sync::mutex::MutexGuard<'_, i32>>>") %0, ptr align 4 %self) unnamed_addr #1 {
start:
; call std::sys::unix::locks::futex_mutex::Mutex::lock
  call void @_ZN3std3sys4unix5locks11futex_mutex5Mutex4lock17h5c2d8edf9743850fE(ptr align 4 %self)
; call std::sync::mutex::MutexGuard<T>::new
  call void @"_ZN3std4sync5mutex19MutexGuard$LT$T$GT$3new17hd3dc7252b85bd0d5E"(ptr sret(%"core::result::Result<std::sync::mutex::MutexGuard<'_, i32>, std::sync::poison::PoisonError<std::sync::mutex::MutexGuard<'_, i32>>>") %0, ptr align 4 %self)
  ret void
}

; std::sync::mutex::MutexGuard<T>::new
; Function Attrs: nonlazybind uwtable
define internal void @"_ZN3std4sync5mutex19MutexGuard$LT$T$GT$3new17hd3dc7252b85bd0d5E"(ptr sret(%"core::result::Result<std::sync::mutex::MutexGuard<'_, i32>, std::sync::poison::PoisonError<std::sync::mutex::MutexGuard<'_, i32>>>") %0, ptr align 4 %lock) unnamed_addr #1 {
start:
  %_4 = alloca ptr, align 8
  %_3 = getelementptr inbounds %"std::sync::mutex::Mutex<i32>", ptr %lock, i32 0, i32 1
; call std::sync::poison::Flag::guard
  %1 = call { i8, i8 } @_ZN3std4sync6poison4Flag5guard17h9a7ce6df96dd7d4dE(ptr align 1 %_3)
...
; call std::sync::poison::map_result
  call void @_ZN3std4sync6poison10map_result17hfc82ea53dd405049E(ptr sret(%"core::result::Result<std::sync::mutex::MutexGuard<'_, i32>, std::sync::poison::PoisonError<std::sync::mutex::MutexGuard<'_, i32>>>") %0, i1 zeroext %_2.0, i8 %_2.1, ptr align 4 %3)
  ret void
}

; std::sync::mutex::MutexGuard<T>::new::{{closure}}
; Function Attrs: inlinehint nonlazybind uwtable
define internal { ptr, i8 } @"_ZN3std4sync5mutex19MutexGuard$LT$T$GT$3new28_$u7b$$u7b$closure$u7d$$u7d$17hdd9d45f4a5e18c4aE"(ptr align 4 %0, i1 zeroext %guard) unnamed_addr #2 {
start:
...
; Function Attrs: nonlazybind uwtable
define internal void @_ZN3std4sync6poison10map_result17hfc82ea53dd405049E(ptr sret(%"core::result::Result<std::sync::mutex::MutexGuard<'_, i32>, std::sync::poison::PoisonError<std::sync::mutex::MutexGuard<'_, i32>>>") %0, i1 zeroext %1, i8 %2, ptr align 4 %f) unnamed_addr #1 {
start:
...
; call std::sync::mutex::MutexGuard<T>::new::{{closure}}
  %14 = call { ptr, i8 } @"_ZN3std4sync5mutex19MutexGuard$LT$T$GT$3new28_$u7b$$u7b$closure$u7d$$u7d$17hdd9d45f4a5e18c4aE"(ptr align 4 %f, i1 zeroext %13)
...
; call std::sync::mutex::MutexGuard<T>::new::{{closure}}
  %25 = call { ptr, i8 } @"_ZN3std4sync5mutex19MutexGuard$LT$T$GT$3new28_$u7b$$u7b$closure$u7d$$u7d$17hdd9d45f4a5e18c4aE"(ptr align 4 %f, i1 zeroext %24)
  %_9.0 = extractvalue { ptr, i8 } %25, 0
  %26 = extractvalue { ptr, i8 } %25, 1
  %_9.1 = trunc i8 %26 to i1
; call std::sync::poison::PoisonError<T>::new
  %27 = call { ptr, i8 } @"_ZN3std4sync6poison20PoisonError$LT$T$GT$3new17h619da38fea622f5dE"(ptr align 4 %_9.0, i1 zeroext %_9.1)
...
; Function Attrs: nonlazybind uwtable
define internal { ptr, i8 } @"_ZN3std4sync6poison20PoisonError$LT$T$GT$3new17h619da38fea622f5dE"(ptr align 4 %guard.0, i1 zeroext %guard.1) unnamed_addr #1 {
start:
...
; std::sync::poison::PoisonError<T>::new
; Function Attrs: nonlazybind uwtable
define internal zeroext i1 @"_ZN3std4sync6poison20PoisonError$LT$T$GT$3new17h69146b16e83f7294E"(i1 zeroext %guard) unnamed_addr #1 {
start:
  %0 = alloca i8, align 1
...
; Function Attrs: inlinehint nonlazybind uwtable
define internal void @_ZN3std4sync6poison4Flag4done17haf55cf6f0e871da6E(ptr align 1 %self, ptr align 1 %guard) unnamed_addr #2 {
start:
...
; call std::panicking::panic_count::count_is_zero
  %_9 = call zeroext i1 @_ZN3std9panicking11panic_count13count_is_zero17h7e188590539bb635E()
  %_6 = xor i1 %_9, true
  %1 = zext i1 %_6 to i8
...
; call core::sync::atomic::atomic_store
  call void @_ZN4core4sync6atomic12atomic_store17h98d537e68a9c59bcE(ptr %self, i8 1, i8 0)
  br label %bb5
}

; std::sync::poison::Flag::guard
; Function Attrs: inlinehint nonlazybind uwtable
define internal { i8, i8 } @_ZN3std4sync6poison4Flag5guard17h9a7ce6df96dd7d4dE(ptr align 1 %self) unnamed_addr #2 {
start:
  %ret = alloca i8, align 1
  %0 = alloca { i8, i8 }, align 1
; call std::panicking::panic_count::count_is_zero
  %_5 = call zeroext i1 @_ZN3std9panicking11panic_count13count_is_zero17h7e188590539bb635E()
  %_3 = xor i1 %_5, true
  %1 = zext i1 %_3 to i8
  store i8 %1, ptr %ret, align 1
; call core::sync::atomic::atomic_load
  %_8 = call i8 @_ZN4core4sync6atomic11atomic_load17h38020492dc1adf58E(ptr %self, i8 0)
  %2 = icmp eq i8 %_8, 0
...
bb1:                                              ; preds = %start
  ...
  %8 = trunc i8 %7 to i1
; call std::sync::poison::PoisonError<T>::new
  %_4 = call zeroext i1 @"_ZN3std4sync6poison20PoisonError$LT$T$GT$3new17h69146b16e83f7294E"(i1 zeroext %8)
...
; Function Attrs: inlinehint nonlazybind uwtable
define internal zeroext i1 @_ZN3std9panicking11panic_count13count_is_zero17h7e188590539bb635E() unnamed_addr #2 {
start:
  %0 = alloca i8, align 1
; call core::sync::atomic::atomic_load
  %_2 = call i64 @_ZN4core4sync6atomic11atomic_load17h321aa2af56d3bd9bE(ptr @_ZN3std9panicking11panic_count18GLOBAL_PANIC_COUNT17hd8bdcf533dbffa86E, i8 0)
...
; call core::fmt::Arguments::new_const
  call void @_ZN4core3fmt9Arguments9new_const17hd9a06c56282fbf58E(ptr sret(%"core::fmt::Arguments<'_>") %_5, ptr align 8 @alloc_560206a49c61adca6f3f0639a12632eb, i64 1)
...
; Function Attrs: inlinehint nonlazybind uwtable
define internal i32 @"_ZN4core3ops8function6FnOnce40call_once$u7b$$u7b$vtable.shim$u7d$$u7d$17h62f47b32500d06d3E"(ptr %_1) unnamed_addr #2 {
start:
  %_2 = alloca {}, align 1
  %0 = load ptr, ptr %_1, align 8, !nonnull !4, !noundef !4
; call core::ops::function::FnOnce::call_once
  %1 = call i32 @_ZN4core3ops8function6FnOnce9call_once17h02937740fac9fd1fE(ptr %0)
  ret i32 %1
}

; core::ops::function::FnOnce::call_once
; Function Attrs: inlinehint nonlazybind uwtable
define internal i32 @_ZN4core3ops8function6FnOnce9call_once17h02937740fac9fd1fE(ptr %0) unnamed_addr #2 personality ptr @rust_eh_personality {
start:
...
; invoke std::rt::lang_start::{{closure}}
  %2 = invoke i32 @"_ZN3std2rt10lang_start28_$u7b$$u7b$closure$u7d$$u7d$17hd22e2ea2d697e22eE"(ptr align 8 %_1)
...
; core::ops::function::FnOnce::call_once
; Function Attrs: inlinehint nonlazybind uwtable
define internal void @_ZN4core3ops8function6FnOnce9call_once17h369d1d6d7cc4d91aE(ptr %_1) unnamed_addr #2 {
start:
  %_2 = alloca {}, align 1
  call void %_1()
  ret void
...
; Function Attrs: nonlazybind uwtable
define internal void @"_ZN4core3ptr60drop_in_place$LT$std..sync..mutex..MutexGuard$LT$i32$GT$$GT$17hfb1ed5940b1f2625E"(ptr %_1) unnamed_addr #1 {
start:
; call <std::sync::mutex::MutexGuard<T> as core::ops::drop::Drop>::drop
  call void @"_ZN79_$LT$std..sync..mutex..MutexGuard$LT$T$GT$$u20$as$u20$core..ops..drop..Drop$GT$4drop17hffa895f72e960d53E"(ptr align 8 %_1)
  ret void
}

; core::ptr::drop_in_place<std::rt::lang_start<()>::{{closure}}>
; Function Attrs: inlinehint nonlazybind uwtable
define internal void @"_ZN4core3ptr85drop_in_place$LT$std..rt..lang_start$LT$$LP$$RP$$GT$..$u7b$$u7b$closure$u7d$$u7d$$GT$17h91c4e3eea4b95564E"(ptr %_1) unnamed_addr #2 {
start:
  ret void
}
...
; Function Attrs: nonlazybind uwtable
define internal void @"_ZN4core3ptr98drop_in_place$LT$std..sync..poison..PoisonError$LT$std..sync..mutex..MutexGuard$LT$i32$GT$$GT$$GT$17h915f88aaf572aaecE"(ptr %_1) unnamed_addr #1 {
start:
; call core::ptr::drop_in_place<std::sync::mutex::MutexGuard<i32>>
  call void @"_ZN4core3ptr60drop_in_place$LT$std..sync..mutex..MutexGuard$LT$i32$GT$$GT$17hfb1ed5940b1f2625E"(ptr %_1)
  ret void
}

; core::sync::atomic::atomic_load
; Function Attrs: inlinehint nonlazybind uwtable
define internal i64 @_ZN4core4sync6atomic11atomic_load17h321aa2af56d3bd9bE(ptr %dst, i8 %0) unnamed_addr #2 {
start:
...
bb6:                                              ; preds = %start
; call core::fmt::Arguments::new_const
  call void @_ZN4core3fmt9Arguments9new_const17hd9a06c56282fbf58E(ptr sret(%"core::fmt::Arguments<'_>") %_5, ptr align 8 @alloc_c986ce739acfc2550367c92bb47d7476, i64 1)
; call core::panicking::panic_fmt
...
bb1:                                              ; preds = %start
; call core::fmt::Arguments::new_const
  call void @_ZN4core3fmt9Arguments9new_const17hd9a06c56282fbf58E(ptr sret(%"core::fmt::Arguments<'_>") %_8, ptr align 8 @alloc_e1829842c862d95248bdb87a26e1372f, i64 1)
; call core::panicking::panic_fmt
...
; core::sync::atomic::atomic_load
; Function Attrs: inlinehint nonlazybind uwtable
define internal i8 @_ZN4core4sync6atomic11atomic_load17h38020492dc1adf58E(ptr %dst, i8 %0) unnamed_addr #2 {
start:
  %_8 = alloca %"core::fmt::Arguments<'_>", align 8
  %_5 = alloca %"core::fmt::Arguments<'_>", align 8
  %1 = alloca i8, align 1
...
; Function Attrs: inlinehint nonlazybind uwtable
define internal void @_ZN4core4sync6atomic12atomic_store17h98d537e68a9c59bcE(ptr %dst, i8 %val, i8 %0) unnamed_addr #2 {
start:
...
bb6:                                              ; preds = %start
; call core::fmt::Arguments::new_const
  call void @_ZN4core3fmt9Arguments9new_const17hd9a06c56282fbf58E(ptr sret(%"core::fmt::Arguments<'_>") %_6, ptr align 8 @alloc_a5cc7fc528e53ce267236c14ebed42c5, i64 1)
; call core::panicking::panic_fmt
...
bb1:                                              ; preds = %start
; call core::fmt::Arguments::new_const
  call void @_ZN4core3fmt9Arguments9new_const17hd9a06c56282fbf58E(ptr sret(%"core::fmt::Arguments<'_>") %_9, ptr align 8 @alloc_e8a173a411485b7e37220624c537a890, i64 1)
; call core::panicking::panic_fmt
...
; Function Attrs: inlinehint nonlazybind uwtable
define internal { i32, i32 } @_ZN4core4sync6atomic23atomic_compare_exchange17h0c52953451464bb6E(ptr %dst, i32 %old, i32 %new, i8 %success, i8 %failure) unnamed_addr #2 {
start:
...
bb8:                                              ; preds = %bb2
; call core::fmt::Arguments::new_const
  call void @_ZN4core3fmt9Arguments9new_const17hd9a06c56282fbf58E(ptr sret(%"core::fmt::Arguments<'_>") %_21, ptr align 8 @alloc_406c3ccfb949c60617508c1453ca62ba, i64 1)
; call core::panicking::panic_fmt
...
bb24:                                             ; preds = %bb2
; call core::fmt::Arguments::new_const
  call void @_ZN4core3fmt9Arguments9new_const17hd9a06c56282fbf58E(ptr sret(%"core::fmt::Arguments<'_>") %_18, ptr align 8 @alloc_53963eedc63e9e4352c653ec571ba638, i64 1)
; call core::panicking::panic_fmt
...
; Function Attrs: inlinehint nonlazybind uwtable
define internal { ptr, i8 } @"_ZN4core6result19Result$LT$T$C$E$GT$6unwrap17h35ef892cbc8a9b5bE"(ptr %self, ptr align 8 %0) unnamed_addr #2 personality ptr @rust_eh_personality {
start:
  %1 = alloca { ptr, i32 }, align 8
...
; invoke core::ptr::drop_in_place<std::sync::poison::PoisonError<std::sync::mutex::MutexGuard<i32>>>
  invoke void @"_ZN4core3ptr98drop_in_place$LT$std..sync..poison..PoisonError$LT$std..sync..mutex..MutexGuard$LT$i32$GT$$GT$$GT$17h915f88aaf572aaecE"(ptr %e) #12
...
; Function Attrs: inlinehint nonlazybind uwtable
define internal i8 @"_ZN54_$LT$$LP$$RP$$u20$as$u20$std..process..Termination$GT$6report17h7bba0d73e21038beE"() unnamed_addr #2 {
start:
  ret i8 0
}
...
; Function Attrs: nonlazybind uwtable
define internal zeroext i1 @"_ZN76_$LT$std..sync..poison..PoisonError$LT$T$GT$$u20$as$u20$core..fmt..Debug$GT$3fmt17he49b29e1e501cde0E"(ptr align 8 %self, ptr align 8 %f) unnamed_addr #1 {
start:
...
; Function Attrs: inlinehint nonlazybind uwtable
define internal void @"_ZN79_$LT$std..sync..mutex..MutexGuard$LT$T$GT$$u20$as$u20$core..ops..drop..Drop$GT$4drop17hffa895f72e960d53E"(ptr align 8 %self) unnamed_addr #2 {
start:
...
; call std::sync::poison::Flag::done
  call void @_ZN3std4sync6poison4Flag4done17haf55cf6f0e871da6E(ptr align 1 %_3, ptr align 1 %_4)
...
; single_mock_deadlock_std_sync::main
; Function Attrs: nonlazybind uwtable
...
; call std::rt::lang_start
  %3 = call i64 @_ZN3std2rt10lang_start17hea127707a9dda385E(ptr @_ZN29single_mock_deadlock_std_sync4main17he9e53c957c22df1fE, i64 %2, ptr %1, i8 0)
